<template>
  <div class="flex min-h-screen">
    ...
    <!-- main -->
    <div class="main w-full bg-slate-100 mt-14 lg:mt-0 lg:px-2">
      <MobileHeader />
      
      <div class="mx-4 md:mx-6 lg:mx-8">
        <div class="my-5 lg:mt-8 font-bold text-gray-800 text-xl mb-6">History Order</div>
              ...
              <template v-if="orders">
                <transition-group name="lists" :appear="true">
                  <tr v-for="(order, index) in orders.data" :key="index">
                      ...
                      <td class="text-center p-3">
                        <div class="truncate font-medium text-gray-500 three-lines bg-neutral-50 border rounded p-2 text-sm">{{order.address}}</div>
                      </td>
