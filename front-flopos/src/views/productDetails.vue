  ...
  <div class="flex min-h-screen">
    ...
    <div class="main w-full lg:w-8/12 bg-slate-100 mt-14 lg:mt-0 lg:ml-16 lg:px-2">
      ...
      <div class="mx-4 md:mx-6 lg:mx-8">
        <div class="my-5 lg:mt-8 font-bold text-gray-800 text-xl mb-6">Product Details</div>
        ...
        <div class="lg:grid lg:grid-cols-3 gap-6 bg-white mt-3 lg:mt-6 p-6 rounded">
