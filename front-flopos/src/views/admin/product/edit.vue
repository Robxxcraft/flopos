  ...
  <div class="main w-full bg-slate-100 lg:ml-3">
    ...
    <div class="m-6 flex justify-center">
      <div class="w-full max-w-2xl rounded shadow-sm py-6 bg-white">
        <div class="text-xl text-blue-500 text-center font-bold mb-2">Edit product - {{ route.params.id }}</div>
        <form class="w-full mx-auto px-6 md:px-8" @submit.prevent="updateProduct">
          ...
          <div class="mt-5 lg:mt-0 lg:flex lg:flex-col lg:items-center items-end lg:basis-1/6">
            ...
            <div class="mt-5 w-full flex items-start justify-end">
...
export default {
  ...
  setup() {
    ...
    const updateProduct = () => {
      ...
      api.post(`/api/products/${route.params.id}`, formData, config).then(res => {
        loading.value = false
    ...
    return { route, toast, openDropdown, chooseCategory, updateProduct, categories, errors, form, image, prevImg, loading, customInput }
  }
};
</script>