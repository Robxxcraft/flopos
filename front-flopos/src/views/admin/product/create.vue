...
<Transition name="slideY">
  ...
  <div class="main w-full bg-slate-100">
    ...
    <div class="py-6 lg:py-8 px-4 md:px-8 lg:px-12">
      ...
      <div class="text-xl text-gray-800 font-bold mt-4 mb-2">Create Product</div>
      <form class="lg:flex flex-wrap gap-16 w-full mx-auto py-8" @submit.prevent="saveProduct">
        <div class="basis-4/6">
  ...
  setup() {
    ...
    const saveProduct = () => {
      ...
      api.post('/api/products', formData, config).then(()=>{
        router.push({name: 'ManageProduct', params: {toast: 'Product has been created'}});
      }).catch(err => { 
        toast.value = true
