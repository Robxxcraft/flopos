    ...
    <div class="main w-full lg:w-8/12 bg-slate-100 mt-14 lg:mt-0 lg:ml-16 lg:px-2">
      ...
      <div class="mx-4 md:mx-6 lg:mx-8">
        ...
        <div class="flex justify-between">
          <div @click="back" class="cursor-pointer font-medium mb-8 text-gray-500 hover:text-blue-500 hover:underline flex items-end gap-1">
        ...
        <div v-if="nextLink" class="btn flex justify-center rounded font-semibold text-base md:text-lg bg-white p-3 shadow-sm text-gray-600 hover:text-blue-500 border-2 hover:border-blue-500 hover:shadow mb-8 cursor-pointer" @click="loadmore()">
